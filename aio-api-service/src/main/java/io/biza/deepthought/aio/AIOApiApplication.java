 ...
 *******************************************************************************/
package io.biza.deepthought.aio;
...
@EnableOAuth2Client
@ComponentScan({"io.biza.deepthought.shared.component",
    "io.biza.deepthought.shared.component.api.controller", "io.biza.deepthought.aio",
    "io.biza.deepthought.banking.api.controller", "io.biza.deepthought.common.api.controller",
    "io.biza.deepthought.discovery.api.controller", "io.biza.deepthought.product.api.controller"})
public class AIOApiApplication {
  ...
  public OpenAPI customOpenAPI(@Value("${deepthought.version}") String appVersion) {
     ...
     */
    return new OpenAPI().info(new Info().title("Deep Thought CDR API").version(appVersion)
        .description(
            "This is the Deep Thought CDR API. It combines all of the separate API services into a single service. You can find out more about Deep Thought at [https://github.com/bizaio/deepthought](https://github.com/bizaio/deepthought) or on the [DataRight.io Slack, #oss](https://join.slack.com/t/datarightio/shared_invite/enQtNzAyNTI2MjA2MzU1LTU1NGE4MmQ2N2JiZWI2ODA5MTQ2N2Q0NTRmYmM0OWRlM2U5YzA3NzU5NDYyODlhNjRmNzU3ZDZmNTI0MDE3NjY).")
