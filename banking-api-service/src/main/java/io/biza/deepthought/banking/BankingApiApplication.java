package io.biza.deepthought.banking;
...
@ComponentScan({"io.biza.deepthought.shared.component", "io.biza.deepthought.shared.security",
    "io.biza.deepthought.data.component", "io.biza.deepthought.product"})
public class BankingApiApplication {
  ...
  public OpenAPI customOpenAPI(@Value("${deepthought.version}") String appVersion) {
     ...
     */
    return new OpenAPI().info(new Info().title("Deep Thought Banking API").version(appVersion)
        .description(
            "This is the Deep Thought Banking API. You can find out more about Deep Thought at [https://github.com/bizaio/deepthought](https://github.com/bizaio/deepthought) or on the [DataRight.io Slack, #oss](https://join.slack.com/t/datarightio/shared_invite/enQtNzAyNTI2MjA2MzU1LTU1NGE4MmQ2N2JiZWI2ODA5MTQ2N2Q0NTRmYmM0OWRlM2U5YzA3NzU5NDYyODlhNjRmNzU3ZDZmNTI0MDE3NjY).")
