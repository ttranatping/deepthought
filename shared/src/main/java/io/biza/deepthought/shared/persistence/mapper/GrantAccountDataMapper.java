...
public class GrantAccountDataMapper implements OrikaFactoryConfigurerInterface {
  ...
  public void configure(MapperFactory orikaMapperFactory) {
    ...
    orikaMapperFactory.classMap(GrantAccountData.class, BankingAccountDetailV1.class)
        ...
        .fieldAToB("account.product.cdrBanking.depositRate", "depositRates")
        .fieldAToB("account.product.cdrBanking.lendingRate", "lendingRates")
        .fieldAToB("account.product.cdrBanking.fee", "fees")
