...
@ToString
@Valid
@Table(name = "PRODUCT_CDR_BANKING_FEE_DISCOUNT_ELIGIBILITY")
public class ProductCdrBankingFeeDiscountEligibilityData {
  ...
  @ToString.Exclude
  private ProductCdrBankingFeeDiscountData discount;
