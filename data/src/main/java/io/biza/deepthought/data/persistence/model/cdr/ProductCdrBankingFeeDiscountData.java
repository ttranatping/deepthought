...
@ToString
@Valid
@Table(name = "PRODUCT_CDR_BANKING_FEE_DISCOUNT")
public class ProductCdrBankingFeeDiscountData {
  ...
  @ToString.Exclude
  private ProductCdrBankingFeeData fee;

  @OneToMany(mappedBy = "discount", cascade = CascadeType.ALL)
  private Set<ProductCdrBankingFeeDiscountEligibilityData> eligibility;
