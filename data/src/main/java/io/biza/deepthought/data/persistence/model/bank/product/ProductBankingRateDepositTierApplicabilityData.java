...
@ToString
@Valid
@Table(name = "PRODUCT_BANKING_RATE_DEPOSIT_TIER_APPLICABILITY")
public class ProductBankingRateDepositTierApplicabilityData {
  ...
  @ToString.Exclude
  ProductBankingRateDepositTierData rateTier;
