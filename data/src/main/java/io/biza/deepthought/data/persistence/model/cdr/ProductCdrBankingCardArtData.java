...
@ToString
@Valid
@Table(name = "PRODUCT_CDR_BANKING_CARD_ART")
public class ProductCdrBankingCardArtData {
  ...
  public void prePersist() {
    if (this.product() != null) {
      Set<ProductCdrBankingCardArtData> set = new HashSet<ProductCdrBankingCardArtData>();
