...
@Repository
public interface GrantAccountRepository extends JpaRepository<GrantAccountData, UUID> {
  public Optional<BankAccountData> findByIdAndGrantSubjectAndGrantExpiryBefore(UUID id, String subject, OffsetDateTime expiry);
