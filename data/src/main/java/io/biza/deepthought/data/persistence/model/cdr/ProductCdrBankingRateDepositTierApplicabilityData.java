...
@ToString
@Valid
@Table(name = "PRODUCT_CDR_BANKING_RATE_DEPOSIT_TIER_APPLICABILITY")
public class ProductCdrBankingRateDepositTierApplicabilityData {
  ...
  @ToString.Exclude
  ProductCdrBankingRateDepositTierData rateTier;
