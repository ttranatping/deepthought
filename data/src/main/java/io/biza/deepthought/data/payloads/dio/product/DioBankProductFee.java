...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "A Deep Thought Product Fee Container")
public class DioBankProductFee {
  ...
  @Schema(description = "CDR Banking Product Fee")
  @Valid
  @NotNull
  @NonNull
  public BankingProductFeeV1 cdrBanking;
