...
public class CustomerBankScheduledPaymentDataMapper implements OrikaFactoryConfigurerInterface {
  ...
  public void configure(MapperFactory orikaMapperFactory) {
    orikaMapperFactory.classMap(CustomerBankScheduledPaymentData.class, DioCustomerScheduledPayment.class)
        .fieldAToB("id", "id")
        .field("", "cdrBanking")
        .byDefault().register();
    ...
    orikaMapperFactory.classMap(CustomerBankScheduledPaymentData.class, BankingScheduledPaymentRecurrenceV1.class)
