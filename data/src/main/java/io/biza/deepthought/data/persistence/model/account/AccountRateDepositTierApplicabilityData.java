...
@ToString
@Valid
@Table(name = "ACCOUNT_RATE_DEPOSIT_TIER_APPLICABILITY")
public class AccountRateDepositTierApplicabilityData {
  ...
  @JoinColumn(name = "ACCOUNT_RATE_DEPOSIT_TIER_ID")
  @ToString.Exclude
  AccountRateDepositTierData rateTier;
