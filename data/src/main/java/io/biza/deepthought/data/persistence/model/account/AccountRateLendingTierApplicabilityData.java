...
@ToString
@Valid
@Table(name = "ACCOUNT_RATE_LENDING_TIER_APPLICABILITY")
public class AccountRateLendingTierApplicabilityData {
  ...
  @JoinColumn(name = "ACCOUNT_RATE_LENDING_TIER_ID")
  @ToString.Exclude
  AccountRateLendingTierData rateTier;
